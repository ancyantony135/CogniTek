...
Backend Status: 🟢 Running | Acceleration: 🚀 NVIDIA RTX 3060 (CUDA) API Base URL: http://localhost:8000
...
5. Pro-Tips for You 
    Interactive Docs: While my backend is running, go to http://localhost:8000/docs. You can test every endpoint there without writing any code.
    ...
    CORS: I have already enabled CORS for localhost:5173. If you change your port, let me know!