...
export default function Logo({ className = "w-16 h-16" }) {
    return (
        <div className={`relative flex items-center justify-center ${className}`}>
            ...
            >
                {/* Shoulders — visible in light/dark mode */}
                <path
                ...
                {/* Refraction Beams */}
                <path d="M90 30L98 25" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5" />
                <path d="M90 30L100 30" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" />
                <path d="M90 30L98 35" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5" />

                {/* Center Focus Point */}
                <circle cx="50" cy="30" r="2.5" fill="#e2e8f0" className="animate-ping" />
